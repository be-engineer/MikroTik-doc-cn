...
本中文手册并非官方发行，完全是自己利用业余时间进行翻译，如有错误和不当之处，请见谅。
...
RouterOS官网文档非常齐全，而且详细，但是只有英文版本，为了方便更多的人学习和了解RouterOS的功能和使用，本人新建了这个项目，把官方文档翻译为中文，希望能对大家有所帮助。


RouterOS官网文档章节内容以及翻译进度说明
----------------------------------------------------------------------

====  =============================================  ===========  ====  ============
序号                      章节                         贡献人     进度    完成时间
====  =============================================  ===========  ====  ============
1.    `Getting Started`                              be-engineer  90%    2023/01/03~2023/01/08
