...
支持CB和PE的设备使用邻居发现协议LLDP和特定的端口扩展TLV。允许CB和PE设备在级联和控制端口上通告它们支持的功能。
...
![](https://help.mikrotik.com/docs/download/attachments/37224456/CB_PE_VLANs.png?version=3&modificationDate=1605189595256&api=v2)

首先，配置CB和PE设备，配置与前面的示例相同。CB设备使用此配置。
