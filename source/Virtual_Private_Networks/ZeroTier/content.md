...
现在通过控制器部分创建一个新的网络，该网络将在 **VL2** 级别上运行。每个网络都有自己的控制器，每个网络ID由控制器地址和控制器ID组合生成。

注意，使用 **private=yes** 选项来获得更安全的网络:
...
Office设备侧配置。启用默认实例，并请求控制器加入879c0b5265a99e4b网络:
...
1) 通过Laptop ZeroTier应用程序，加入了879c0b5265a99e4b网络;
